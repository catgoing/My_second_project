	...
	<table style="table-layout:fixed">
		...
		<c:if test="${not empty comlist }">
			<c:forEach var="comvo" items="${comlist }">
				...
				<tr class="list" onclick="location.href = '/savanna/board/view.jsp?rev_no=${comvo.rev_no }'">
					<td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">${comvo.comm_content }</td>
					<td style="width: 30%;">${comvo.comm_date }</td>
				</tr>
